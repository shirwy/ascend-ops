...
set_atomic_none();
  uint64_t status_overflow[1] = {0};
   int16_t reg_buf1[1] = {0};
__ubuf__   int16_t* src_ub = (__ubuf__  int16_t *)get_imm(0);
   uint16_t reg_buf2[1] = {0};
// "aicore arch: Ascend910"
  reg_buf1[0] = (int16_t) (*( __ubuf__ int16_t* ) (((__ubuf__ int16_t *)src_ub)));
  reg_buf2[0] = (uint16_t) (*( __ubuf__ uint16_t* ) (((__ubuf__ uint16_t *)src_ub)));
  set_flag(PIPE_S, PIPE_V, EVENT_ID0);
  reg_buf2[0] = (reg_buf2[0] % (uint16_t)8ULL);
  set_vector_mask(0x0, 0xffff);
  wait_flag(PIPE_S, PIPE_V, EVENT_ID0);
  for (int32_t i = 0; i < 8; ++i) {
    vector_dup(((__ubuf__ int16_t *)src_ub + ((i * 16384) + (((int32_t)reg_buf2[0]) * 16))), reg_buf1[0], 96, 1, 0, 8, 0);
  }
